...
function TaskForm({ addTask, existingCategories }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="mb-8 p-4 sm:p-6 rounded-lg shadow-lg bg-background dark:bg-background-dark transition-colors duration-300">
      ...
      */}
      <div className="mb-4">
        <input
          ...
          className="w-full p-3 text-lg sm:text-xl border-2 border-primary-light dark:border-primary-dark rounded-md
                     ...
                     bg-gray-50 dark:bg-gray-700 text-text dark:text-text-dark
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        */}
        <div>
          <label htmlFor="category-input" className="block text-sm font-medium mb-1 text-text dark:text-text-dark">Category (optional)</label>
          <input
            id="category-input"
            type="text"
        ...
        <div>
          <label className="block text-sm font-medium mb-1 text-text dark:text-text-dark">Priority</label>
